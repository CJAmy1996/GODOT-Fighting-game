...
public partial class StageCamera : Camera2D
{
    ...
    [Export] public float CameraHeight { get; set; } = 420f;
    [Export] public float FollowSpeed { get; set; } = 7f;
    [ExportGroup("Fight Box")]
    [Export] public float CloseFightBoxWidth { get; set; } = 900f;
    [Export] public float FarFightBoxWidth { get; set; } = 1040f;
    [Export] public float FighterHorizontalPadding { get; set; } = 210f;
    [ExportGroup("Vertical Follow")]
    [Export] public float SuperJumpFollowHeight { get; set; } = 120f;
    [Export] public float SuperJumpFollowWeight { get; set; } = 0.72f;
    [ExportGroup("Zoom")]
