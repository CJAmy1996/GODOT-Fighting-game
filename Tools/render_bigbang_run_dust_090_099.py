"""Render BBB common Smoke 2 as the reusable run-dust animation."""
...
OUTPUT = SOURCE.parent / "Review" / "run_dust_090_099_preview.gif"
CANVAS = (256, 128)
ANCHOR = (96, 88)
ORIGINS = ((0, 4), (0, 4), (-40, 4), (-40, 4), (-34, 4),
           (-34, 4), (-34, 4), (-60, 0), (-60, -2), (-66, -8))
...
def main() -> None:
    ...
    for number, origin in zip(range(90, 100), ORIGINS):
